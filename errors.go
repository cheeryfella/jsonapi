...
type ErrorObject struct {
	...
	// Links is a link object providing access to further details on the problem.
	...
	// Source is an object providing information on the entity within the json payload or the URL parameter that is the culprit causing the error.
...
// ErrorLink is an object providing access to the `about` detail of an error.
